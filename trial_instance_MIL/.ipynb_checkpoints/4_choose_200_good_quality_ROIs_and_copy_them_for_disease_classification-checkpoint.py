...
parent_dir = root_dir / '16tb2/ALL_Subtype_Classification/trial_MIL_dataset'

# load cohort data from json
with open(root_dir / '16tb2/ALL_Subtype_Classification/trial_instance_MIL_cohort.json', 'r') as f:
    temp = json.load(f)
cohort = deepcopy(temp)

for group in ['training', 'validation', 'test']:
    for label in ['B-ALL', 'T-ALL']:
...
with open(root_dir / '16tb2/ALL_Subtype_Classification/trial_instance_MIL_tiles.json', 'w') as f:
    json.dump(cohort, f)